    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="slick_slider">
          ...
          <div class="single_iteam"> <a href="#"> <img src="/SportMgmt/images/ban-3.jpg" alt=""></a>
            <div class="slider_article">
              <h2><a class="slider_tittle" href="pages/single_page.html">Fusce eu nulla semper porttitor felis sit amet</a></h2>
              <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui...</p>
            </div>
          ...
          <div ><a href="#"><img class="img-responsive" src="/SportMgmt/images/addbanner_728x90_V1.jpg" alt=""></a></div>
           ...
           <div class="single_post_content">
              ...
              <ul class="business_catgnav">
                <li>
                  <figure class="bsbig_fig  wow fadeInDown"> <a class="featured_img" href="/SportMgmt/pages/single_page.html"> <img src="/SportMgmt/images/featured_img1.jpg" alt=""> <span class="overlay"></span> </a>
                    <figcaption> <a href="#">Play MatchBoss and Win 50,000 Pounds!</a> </figcaption>
            ...
            <div class="single_post_content_right">
              <ul class="spost_nav">
                <li>
                  <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="/SportMgmt/images/post_img1.jpg"> </a>
                ...
                <li>
                  <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="/SportMgmt/images/post_img2.jpg"> </a>
