   ...
   <div class="large-12 columns">
    ...
    <div class="large-12 columns">
       ...
       <option value="${countryObj.key}">${countryObj.key}</option>
        ...
        <div class="large-12 columns">
            <input type="input" name="contactNumber" placeholder="Mobile Number" required  id="contactNumber" />
        </div>
        <div class="large-12 columns">
...
<%-- <div class="reveal medium" id="exampleModal2" data-reveal>
  <form name="LoginForm" action="" method="get" onsubmit="event.preventDefault();">
        ...
        <div class="large-12 columns">   
        	<div align="left">
             	<a href="javascript:void(0);" data-open="exampleModal1" class="button btnSubmit">
             		Sign Up
             	</a>
             </div>         
             <div align="right">
             	<a href="javascript:void(0);" class="button-lrg">
             		<input type="submit" class="button btnSubmit" value="LOG IN" onclick="doLogin();">
             	</a>
             </div>
         </div>
    </form>
...
<section id="navArea">
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        ...
        <h2 class="subHeader league-sub-header">
			<c:if test="${not empty sessionScope.user.displayName}">Welcome ${sessionScope.user.displayName}</c:if>
		</h2>
      </div>
    </nav>
</section>
